...
class Management:
    ...
    def AddStudent(self):
        ...
        bg=self.color_5,fg=self.color_3).place(x=250,y=520,width=100)

        self.submit_bt_1 = Button(self.frame_2, text='Login', font=(self.font_1, 12), bd=2, command=self.GetContact_View, cursor="hand2",
        bg=self.color_5,fg=self.color_3).place(x=500,y=520,width=100)
    ...
    def GetContact_View(self):
        ...
        bg=self.color_5,fg=self.color_3).place(x=350,y=280,width=80)

        self.submit_bt_2 = Button(self.frame_2, text='Exit', font=(self.font_1, 12), bd=2, command=self.Exit, cursor="hand2",
        bg=self.color_5,fg=self.color_3).place(x=500,y=280,width=80)
